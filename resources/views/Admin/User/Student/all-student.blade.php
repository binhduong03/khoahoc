                ...
                <div class="card">
                    <div class="card-header">
                        <div class="d-flex justify-content-between w-100">
                            ...
                            <a href="#" data-bs-toggle="modal" data-bs-target="#add-student" class="btn btn-primary mb-2"><i class="fas fa-plus"></i>Thêm mới</a>
                                ...
                                <tbody>
                                    @foreach($all_student as $all )
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex">
                                                    <a href="{{URL::to('Admin/edit-student/'. $all->user_id)}}" class="btn btn-warning shadow btn-xs sharp me-1" title="Sửa"><i class="fas fa-pencil-alt"></i></a>
                                                    <a href="#" data-bs-toggle="modal" data-bs-target="#detail-student{{$all->user_id}}" class="btn btn-primary shadow btn-xs sharp me-1"><i class="fas fa-eye"></i></a>
                                                    <a href="#" data-bs-toggle="modal" data-bs-target="#delete-student{{$all->user_id}}" class="btn btn-danger shadow btn-xs sharp" title="Xóa"><i class="fa fa-trash"></i></a>
                                                </div>
                                            </td>
                                        </tr>
                                    @endforeach
   ...
   <!-- Thêm người dùng -->
    <div class="modal fade" id="add-student" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <form action="{{route('admin.save-student')}}" method="post" enctype="multipart/form-data">
                @csrf
    ...
    <!-- Xem chi tiết -->
    @foreach($all_student as $all)
        <div class="modal fade" id="detail-student{{$all->user_id}}" aria-labelledby="exampleModalLabbel" aria-hidden="true">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
    ...
    <!-- Xóa người dùng -->
    @foreach($all_student as $all)
        <div class="modal fade" id="delete-student{{$all->user_id}}" aria-labelldby="exampleModalLabbel1" aria-hidden="true">
